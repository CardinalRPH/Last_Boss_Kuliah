...
const DetailPageSoilBotCard = ({ value=0 }) => {
    return (
        <Paper
            sx={{
                p: 2,
        ...
        >
            ...
            <Box sx={{ m: 1 }}>
                ...
                <Typography variant="body1">Soil Bot Value</Typography>
            </Box>
        </Paper>
    )
}

DetailPageSoilBotCard.propTypes = {
    value: PropTypes.number.isRequired
}

export default DetailPageSoilBotCard